        ...
        <div class="col-sm-9 col-md-10">
          <div class="header_info">
            <div class="header_widgets">
              ...
              <a href="mailto:taxihire@gmail.com">taxihire@gmail.com</a> </div>
            <div class="header_widgets">
              <div class="circle_icon"> <i class="fa fa-phone" aria-hidden="true"></i> </div>
              <p class="uppercase_text">Call Us: </p>
              <a href="tel:61-1234-5678-09">+254-743229542</a> </div>
...
echo "Welcome To Taxi hire portal";
 } ?>
          </div>
        </div>
      </div>
...
foreach($results as $result)
   ...
   <!-- <i class="fa fa-angle-down" aria-hidden="true"></i></a> -->
          ...
          <li><a href="my-testimonials.php">My Testimonial</a></li>
            ...
            <li><a href="#loginform"  data-toggle="modal" data-dismiss="modal">Bookings</a></li>
      ...
      <div class="collapse navbar-collapse" id="navigation">
        <ul class="nav navbar-nav">
          ...
          <li><a href="car-showcase.php">Car Showcase</a>
          <li><a href="page1.php">FAQs</a></li>
